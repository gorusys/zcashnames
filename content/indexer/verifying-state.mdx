...
The claim "ZNS is trust-minimized" only holds if clients actually verify what they get back from the RPC. This page walks through the three verification layers in order of increasing paranoia. For the formal trust assumptions this verification rests on, see the [Trust Model](/docs/protocol/trust-model).
